...
╺━ CONFIG ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸
 ...
 47 keys · 12 unset · a running widget will not pick a change up until it restarts

▸ clocks.show_hints              true              true           set
  clocks.work_end_hour           18                18             set
  github.token                   ••••••••          ""             set
  latency.hosts                  array · 3         array · 3      set
  usage.grok_ping                —                 false          unset
...
`github.token`, `linear.token` and `deployments.token` are redacted until
`s` reveals them. `c` copies a value that is not a token, and refuses
rather than putting a secret on the clipboard.
